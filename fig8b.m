...
% Date: 9/1/2020
% Description:  This script generates the Figure 8b in the paper
...
for c = 1:cmax %order of Lyapu = 2c
   [P,gammma] = commonLyap(c,A1,A2,B1,C1,n, div(c));
...
boundu = y + BOUND(1)*exp(-div(2)*time)';
boundl = y - BOUND(1)*exp(-div(2)*time)';
...
%matlab2tikz('F8b.tikz', 'width', '6cm', 'height', '4cm')
